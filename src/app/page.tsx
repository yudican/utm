  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        if (!code) {
          throw new Error('Kode URL tidak ditemukan dalam URL. Format yang benar: domain.com/nYRU4u')
        }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center p-4">
        <Card className="w-full max-w-md p-8 text-center bg-white/10 backdrop-blur-lg border-white/20">
          ...
          <h1 className="text-xl font-semibold text-white mb-2">Terjadi Kesalahan</h1>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-8 text-center bg-white/10 backdrop-blur-lg border-white/20">
        ...
        <h1 className="text-xl font-semibold text-white mb-2">Memproses Permintaan</h1>
